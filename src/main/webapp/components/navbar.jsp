    ...
    <header class="header">
        ...
        <nav class="nav" id="nav">
            ...
            <ul class="nav-menu">
                ...
                <% } else { %>
                <li class="nav-item"><a href="/CafeOS/order_history.jsp" class="nav-link">History</a></li>
                <li class="nav-item"><a href="/CafeOS/logout" class="nav-link">Logout</a></li>
                <li class="nav-item"><a href="/CafeOS/action/checkout.jsp" class=" btn-primary"><i class="fas fa-shopping-cart"></i> Cart</a></li>
                <% } %>
            </ul>
        </nav>
    </header>
